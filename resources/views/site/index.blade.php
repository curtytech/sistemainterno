...
<body class="font-sans bg-white text-slate-900">
  ...
  ['nome' => 'Solicitação Manutenção', 'link' => 'https://sequoiamanutencao.vercel.app/login', 'logo' => '/assets/logo-grupo-sequoia.png'],
  ['nome' => 'Solicitação Patrimonial', 'link' => 'https://forms.office.com/Pages/ResponsePage.aspx?id=iQL2wSFX90aaQLCc6Yi0DJLv1d-JqxVOkIzJSns4QY1UOTlMSFQ5NlYxUUdJTUw2UlhTSlJUR0dRNyQlQCN0PWcu', 'logo' => 'https://www.google.com/s2/favicons?domain=forms.office.com&sz=128'],
  ['nome' => 'Plataforma de Treinamentos', 'link' => 'https://gruposequoia.grupoimpulsionar.com/', 'logo' => '/assets/logo-grupo-sequoia.png'],
  ['nome' => 'Solicitação Admissão de Colaboradores', 'link' => 'https://forms.office.com/pages/responsepage.aspx?id=iQL2wSFX90aaQLCc6Yi0DJOpBteh8IVCkQqORfhz3J1UNjBVUkpSSjgwWlZUOEExWkhTSEM5SlVXTi4u&route=shorturl'],
  ...
  <div class="text-slate-900 font-sans bg-white ">
    ...
    @include('site.partials.noticias')
